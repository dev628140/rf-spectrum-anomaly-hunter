    ...
    <div className="flex min-h-screen bg-[#050816] text-white">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-6 space-y-6 overflow-y-auto flex-1">
          ...
          {/* Telemetry Charts: FFT & Spectrogram Heatmap (Symmetric Height 540px) */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <div className="min-w-0 flex flex-col h-[540px]">
              <RFSpectrum />
            </div>
            <div className="min-w-0 flex flex-col h-[540px]">
              <RFWaterfall />
          ...
          {/* AI Threat Context & Multi-Model Analysis (Symmetric Height 500px) */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
            
            {/* Realtime Multi-Model Comparison Panel */}
            <div className="min-w-0 flex flex-col h-[500px]">
              <ModelComparison />
            </div>
            ...
            <div className="min-w-0 flex flex-col h-[500px]">
              {explanation.data?.explanation ? (
                ...
                <div className="rounded-[2rem] border border-cyan-500/10 bg-[#07111f] p-6 flex-1 flex items-center justify-center h-full shadow-[0_0_50px_rgba(0,255,255,0.02)]">
                  <div className="text-center">
                    <p className="text-3xl font-black text-cyan-300 animate-pulse mb-3 font-mono tracking-widest">
                      ANALYZING...
                    </p>
